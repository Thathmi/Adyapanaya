...
public class New_Teacher extends javax.swing.JDialog {

    Teacher t;
    ClassRegistration cr;
    String subjects;

    public New_Teacher(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.t = (Teacher) parent;

        initComponents();
        setLocationRelativeTo(null);
    }

    public New_Teacher(ClassRegistration parent, boolean modal) {
        super(parent, modal);
        this.cr = parent;
    ...
    private void initComponents() {
        ...
        setTitle("Adyapanaya Institute - Register New Teacher");
        ...
        jLabel7.setText("Admmission payment");
        ...
        jLabel10.setText("20% of class fee");
        ...
        jLabel11.setText("Register new Teacher");
...
//        teacher insert
            MySQL.iud("INSERT INTO `teacher`(`unique_id`,`Name`,`Address`,`reg_date`) VALUES('" + uniqueId + "','" + name + "','" + address + "','" + dNow + "') ");

            try {
                ResultSet rs2 = MySQL.search("SELECT * FROM `teacher` WHERE `unique_id`='" + uniqueId + "'");
                rs2.next();
                String t_no = rs2.getString("Tno");

                MySQL.iud("INSERT INTO `teacher_addmission`(`Tno`,`amount`,`balance`) VALUES('" + t_no + "','" + payment + "','" + balance + "')");

            } catch (Exception e) {
                e.printStackTrace();
            }
            JOptionPane.showMessageDialog(this, "New Teacher added", "INFORMATION", JOptionPane.INFORMATION_MESSAGE);
            ...
            try {
                ...
                parameters.put("Parameter1", "Teacher registration addmission fee");
...
//display balance
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                New_Teacher dialog = new New_Teacher(new javax.swing.JFrame(), true);
