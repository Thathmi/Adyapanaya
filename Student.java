...
//            name
            if (!name.isEmpty()) {
                queryVector.add("`Name` LIKE '%" + name + "%' ");
            }

            //          address
            if (address.isEmpty()) {
            } else {
                queryVector.add("`student`.`Address` LIKE '%" + address + "%' ");
            }

            if (!id_fr.isEmpty()) {
                if (id_to.isEmpty()) {
                    queryVector.add("`student`.`Sno`>='" + id_fr + "'");
                } else {
                    queryVector.add("`student`.`Sno`>='" + id_fr + "' AND `student`.`Sno`<='" + id_to + "'  ");
                }
            }

            if (!id_to.isEmpty()) {
                queryVector.add("`student`.`Sno`<='" + id_to + "'");
            }
            ...
            ResultSet rs = MySQL.search("SELECT * FROM  `student` " + wherequery + " ORDER BY `Sno` ASC");
    ...
    private void initComponents() {
        ...
        setTitle("Adyapanaya Institute - Student page");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Student Name", "Dob", "Address"
            }
        ) {
        ...
        jMenu2.setText("        Register New Student");
...
//update
        ...
        if (selectedRow == -1) {
            ...
            if (!newName.isEmpty()) {
                if (newAddress.isEmpty()) {
                    MySQL.iud("UPDATE `student` SET `Name`='" + newName + "' WHERE `Sno` = '" + Sno + "'");
                                JOptionPane.showMessageDialog(this, "Student updated", "Information", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    MySQL.iud("UPDATE `student` SET `Name`='" + newName + "' AND `Address`='" + newAddress + "' WHERE `Sno` = '" + Sno + "'");
                                JOptionPane.showMessageDialog(this, "Student updated", "Information", JOptionPane.INFORMATION_MESSAGE);
                }
            } else {
                if (!newAddress.isEmpty()) {
                    MySQL.iud("UPDATE `student` SET  `Address`='" + newAddress + "' WHERE `Sno` = '" + Sno + "'");
                                JOptionPane.showMessageDialog(this, "Student updated", "Information", JOptionPane.INFORMATION_MESSAGE);
                }else{
                            JOptionPane.showMessageDialog(this, "No data to update", "Warning", JOptionPane.WARNING_MESSAGE);
                }
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            MySQL.iud("UPDATE `student` SET  `status`='2' WHERE `Sno` = '" + Sno + "'");
    ...
    private void jMenu2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu2MouseClicked
         New_Student ns = new New_Student(this, true);
        ns.setVisible(true);
